...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 400.0, 261.0, 32.5, 20.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 64.0, 272.0, 32.5, 20.0 ],
					"text" : "b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 578.0, 144.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 32.0, 184.0, 32.5, 20.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 32.0, 559.0, 18.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 559.0, 144.0, 18.0 ],
					"text" : "< Stop held notes after editing"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 400.0, 559.0, 18.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 344.0, 576.0, 158.0, 18.0 ],
					"text" : "< Provide note-offs for held notes"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 296.0, 552.0, 31.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 256.0, 8.0, 32.0, 15.0 ],
					"prototypename" : "numbers.default",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "StopNotes",
							"parameter_mmax" : 1,
							"parameter_speedlim" : 0.0,
							"parameter_shortname" : "StopNotes",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 600.0, 109.0, 20.0 ],
					"text" : "noteout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 392.0, 600.0, 72.0, 19.0 ],
					"text" : "MIDI to Live",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 280.0, 576.0, 64.0, 20.0 ],
					"text" : "flush"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 144.0, 42.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 131.0, 0.0, 42.0, 18.0 ],
					"text" : "Modes"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 64.0, 248.0, 31.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 199.0, 16.0, 31.0, 15.0 ],
					"prototypename" : "numbers.default",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "PitchRand",
...
,
					"patching_rect" : [ 64.0, 224.0, 91.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 32.0, 160.0, 72.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 112.0, 16.0, 80.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 184.0, 232.0, 19.0, 18.0 ],
					"text" : "l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 152.0, 113.0, 85.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.0, 528.0, 123.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 440.0, 384.0, 144.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 384.0, 93.0, 18.0 ],
					"text" : "<-----------------------"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 472.0, 360.0, 118.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 605.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 30.093367000000001, 20.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 589.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 39.818367000000002, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 573.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 50.107844999999998, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 557.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 59.832850999999998, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 541.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 70.122330000000005, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 525.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 79.847328000000005, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 509.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 89.572333999999998, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 493.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 99.861808999999994, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 477.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 109.586815000000001, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 461.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 120.311820999999995, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 445.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 130.165771000000007, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 429.0, 344.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.431519000000009, 139.890778000000012, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
,
					"patching_rect" : [ 432.0, 296.0, 194.5, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Arial Bold",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 608.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 211.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 592.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 198.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 576.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 185.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 560.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 172.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 544.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 159.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 528.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 146.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 512.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 133.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 496.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 480.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 107.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 464.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 94.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 448.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 81.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 432.0, 320.0, 20.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 68.0, 150.0, 20.0, 19.0 ],
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 368.0, 407.0, 42.0, 18.0 ],
					"text" : "Octave"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 376.0, 43.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 251.0, 28.0, 43.0, 18.0 ],
					"text" : "Output",
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 307.0, 349.0, 53.0, 18.0 ],
					"text" : "Mapping"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 376.0, 35.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 28.0, 35.0, 18.0 ],
					"text" : "Input",
					"textcolor" : [ 0.301961, 0.337255, 0.403922, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.0, 208.0, 47.0, 18.0 ],
					"text" : "Others >"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 200.0, 392.0, 48.0, 133.333344000000011 ],
					"presentation" : 1,
					"presentation_rect" : [ 248.0, 28.0, 48.0, 133.333344000000011 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 392.0, 48.0, 133.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 248.0, 28.0, 48.0, 133.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 360.0, 424.0, 40.0, 20.0 ],
					"prototypename" : "Live",
					"triscale" : 0.75
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 280.0, 248.0, 64.0, 20.0 ],
					"text" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 280.0, 440.0, 32.5, 20.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 280.0, 312.0, 33.0, 20.0 ],
					"text" : "% 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 280.0, 464.0, 33.0, 20.0 ],
					"text" : "% 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 280.0, 512.0, 152.5, 20.0 ],
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 240.0, 36.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 0.0, 36.0, 18.0 ],
					"text" : "Tonic"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 400.0, 240.0, 32.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 16.0, 32.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
							"parameter_linknames" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 32.0, 280.0, 124.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 280.0, 65.0, 18.0 ],
									"text" : "vexpr $i1+1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "list" ],
									"patching_rect" : [ 176.0, 304.0, 63.0, 18.0 ],
									"text" : "listfunnel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 176.0, 216.0, 109.0, 18.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 176.0, 192.0, 39.0, 18.0 ],
									"prototypename" : "Live",
									"triscale" : 0.75
								}
...
,
					"patching_rect" : [ 136.0, 248.0, 83.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Arial Bold",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 144.0, 392.0, 48.0, 133.333344000000011 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 28.0, 48.0, 133.333344000000011 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 280.0, 336.0, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 280.0, 278.0, 32.5, 20.0 ],
					"text" : "-"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 360.0, 464.0, 32.5, 20.0 ],
					"text" : "* 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 280.0, 488.0, 98.5, 20.0 ],
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 360.0, 312.0, 32.5, 20.0 ],
					"text" : "/ 12"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "", "", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 280.0, 364.0, 72.0, 72.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 72.0, 34.0, 156.0, 120.0 ],
					"rounded" : 0.0,
					"rows" : 12,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 3,
							"parameter_longname" : "PitchMap",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 424.0, 208.0, 58.0, 19.0 ],
					"text" : "MIDI thru",
					"textcolor" : [ 0.3, 0.34, 0.4, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 376.0, 208.0, 47.0, 20.0 ],
					"text" : "midiout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 208.0, 45.0, 18.0 ],
					"text" : "< Notes"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 280.0, 184.0, 114.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 280.0, 160.0, 40.0, 20.0 ],
					"text" : "midiin"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.0, 14.0, 442.0, 19.0 ],
					"prototypename" : "M4L.patcher-summary",
					"text" : "See how to create a device partly reverse-engineered from an existing Live device"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 8.0, 109.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 32.0, 608.0, 93.0 ],
					"prototypename" : "M4L.patcher-story",
					"text" : "The behavior of this device imitates the behavior of Live's Scale MIDI effect, which shifts incoming pitches in order to fit a given mode or scale. We’re duplicating the Live effect in order to demonstrate how such mapping is done using Max objects. Data mapping is a topic of considerable interest in Max generally, and for MIDI in particular. In this patch, we're using the live.grid object in \"matrix\" mode in order to process the mapping itself - a pitch in the scale is mapped to another pitch. To be specific, an input index to live.grid is set to a (potentially) different output index. The other interesting feature is a demonstration of how Max does data storage. Take a look inside the Modes subpatcher to see how pitch mode presets are stored and recalled in order to fill live.grid."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 649.0, 265.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 649.0, 265.0, 50.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.0, 160.0, 86.0, 19.0 ],
					"text" : "MIDI from Live",
					"textcolor" : [ 0.3, 0.34, 0.4, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.0, 392.0, 48.0, 133.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 28.0, 48.0, 133.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 109.5, 364.5, 289.5, 364.5 ],
					"source" : [ "obj-108", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 87.0, 299.0, 56.25, 299.0, 56.25, 214.0, 145.5, 214.0 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 289.5, 303.5, 369.5, 303.5 ],
					"order" : 0,
					"source" : [ "obj-76", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-52" : [ "PitchRand", "PitchRand", 0 ],
			"obj-9" : [ "StopNotes", "StopNotes", 0 ],
			"obj-7" : [ "PitchMode", "PitchMode", 0 ],
			"obj-60" : [ "Tonic", "Tonic", 0 ],
			"obj-51" : [ "PitchMap", "PitchMap", 1 ],
			"parameterbanks" : 			{
