...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 332.0, 465.0, 31.0, 22.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 524.0, 69.0, 22.0 ],
					"text" : "144, 60, 60"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 748.0, 32.0, 22.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 562.0, 62.0, 22.0 ],
					"text" : "144, 60, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 71.0, 492.0, 139.0, 22.0 ],
					"text" : "dict.unpack midi: firstCh:"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 239.0, 316.0, 19.0, 22.0 ],
									"text" : "t l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 304.0, 316.0, 19.0, 22.0 ],
									"text" : "t l"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 2,
									"outlettype" : [ "script", "terminated" ],
									"patching_rect" : [ 392.333333333333371, 264.0, 104.0, 22.0 ],
									"text" : "t script terminated"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 2,
									"outlettype" : [ "script", "stopped" ],
									"patching_rect" : [ 315.666666666666686, 227.0, 90.0, 22.0 ],
									"text" : "t script stopped"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 2,
									"outlettype" : [ "script", "started" ],
									"patching_rect" : [ 239.0, 193.0, 84.0, 22.0 ],
									"text" : "t script started"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 239.0, 144.0, 249.0, 22.0 ],
									"text" : "routepass start stop terminated"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 469.0, 182.0, 101.0, 22.0 ],
									"text" : "print parse-status"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.0, 432.0, 79.0, 22.0 ],
									"text" : "loadmess set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 169.0, 391.0, 41.0, 22.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 391.0, 41.0, 22.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 193.0, 138.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 144.0, 83.0, 22.0 ],
									"text" : "route success"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 100.0, 208.0, 22.0 ],
									"text" : "route npm"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 169.0, 473.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 188.0, 317.0, 85.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 451.0, 170.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 70.0, 529.0, 113.0, 22.0 ],
